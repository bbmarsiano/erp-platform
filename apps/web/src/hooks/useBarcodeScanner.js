...
export function useBarcodeScannerInput({ onScan, minLength = 3, timeout = 150, active = true }) {
    const buffer = useRef('');
...
export function useCameraScanner({ onScan, active = false, elementId = 'camera-preview' }) {
