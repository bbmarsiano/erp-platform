...
export default function WmsDashboard() {
    ...
    return (_jsxs("div", { style: { padding: 20 }, children: [_jsx("div", { style: { display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 16 }, children: _jsxs("div", { children: [_jsx("div", { style: { fontSize: 22, fontWeight: 900 }, children: "\u0421\u043A\u043B\u0430\u0434 (WMS)" }), _jsx("div", { style: { marginTop: 4, color: '#6b7280', fontSize: 13 }, children: "\u041E\u0431\u0437\u043E\u0440 \u0438 \u043A\u043B\u044E\u0447\u043E\u0432\u0438 \u043F\u043E\u043A\u0430\u0437\u0430\u0442\u0435\u043B\u0438" })] }) }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: 12 }, children: [_jsx(StatCard, { title: "\u041E\u0431\u0449\u043E \u0441\u043A\u043B\u0430\u0434\u043E\u0432\u0435", value: warehouses.isLoading ? '...' : totals.warehousesCount }), _jsx(StatCard, { title: "\u0410\u0440\u0442\u0438\u043A\u0443\u043B\u0438 \u0441 \u043D\u0430\u043B\u0438\u0447\u043D\u043E\u0441\u0442", value: stockSummary.isLoading ? '...' : totals.stockedItemsCount }), _jsx(StatCard, { title: "\u0427\u0435\u0440\u043D\u043E\u0432\u0438 \u043F\u0440\u0438\u0445\u043E\u0434\u043D\u0438", value: receipts.isLoading ? '...' : totals.draftReceiptsCount }), _jsx(StatCard, { title: "\u0410\u0440\u0442\u0438\u043A\u0443\u043B\u0438 \u043F\u043E\u0434 \u043C\u0438\u043D\u0438\u043C\u0443\u043C", value: lowStock.isLoading ? '...' : totals.lowStockCount })] }), lowStockData && lowStockData.length > 0 ? (_jsxs("div", { onClick: () => navigate('/wms/stock'), style: {
                    marginTop: '20px',
                    padding: '14px 18px',
                    background: '#fef2f2',
